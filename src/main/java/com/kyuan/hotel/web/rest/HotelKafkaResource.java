...
@RestController
@RequestMapping("/api/hotel-kafka")
public class HotelKafkaResource {
    private final Logger log = LoggerFactory.getLogger(HotelKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HotelKafkaResource(KafkaProperties kafkaProperties) {
